...
**Plus, for this role**
- Measure and profile before optimizing — never optimize on intuition
- Record before/after baselines for anything you change
- Don't add complexity the actual load profile doesn't justify — flag premature optimization
